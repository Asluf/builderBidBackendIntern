import { getUser, saveFloorPlan, getAllFloorPlan, getFloorPlan, getFloorPlanByType,updateFloorPlan, deleteFloorPlan} from "../controllers/planController";
...
router.get("/get_one-floor_plan/:plan_id", getFloorPlan);
